...
$(".layout-14 .pcoded-inner-navbar > li.pcoded-hasmenu").on("mouseenter", function() {
    if (vw >= 992) {
        ...
        var j = new PerfectScrollbar(".navbar-popup > .pcoded-submenu", {
            wheelSpeed: 0.5,
            swipeEasing: 0,
            suppressScrollX: !0,
            wheelPropagation: 1,
...
// $("body").append('<div class="fixed-button active"><a href="https://codedthemes.com/item/flash-able-bootstrap-admin-template/" target="_blank" class="btn btn-md btn-primary"><i class="fa fa-shopping-cart" aria-hidden="true"></i> Upgrade To Pro</a> </div>');
// var $window = $(window),
//     nav = $(".fixed-button");